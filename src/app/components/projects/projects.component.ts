...
export class ProjectsComponent implements OnInit {
  ...
  projectsArray : Array<Project> = [
    new Project(1,'Team Portfolio', 'Our web development team portfolio', '', '2023-02-01', '2023-01-07', 'Completed', 'assets/team.PNG', 'https://github.com/dkrymlov/team-portfolio'),
    new Project(2,'My Portfolio', 'My developer portfolio', '', '2023-02-08', '2023-02-15', 'Completed', 'assets/firstpreview.PNG', ''),
    new Project(3,'ToDo List', 'Nice ToDo List with JWT Auth', '', '2022-09-05', '2022-09-24', 'Completed', 'assets/todo.PNG', 'https://github.com/dkrymlov/WEBLab'),
    new Project(5,'MeatAlibaba', 'Website for a local meat shop', '', '2023-01-01', '2023-01-28', 'Completed', 'assets/meatali.PNG', 'https://meatalibaba.com/'),
  ]
